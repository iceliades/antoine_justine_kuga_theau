...
//----------------------------- Stats ----------------------------------
            ...
            int nb = 15;
            stats.setDammages(nb);
            stats.setMinRange(nb);
            stats.setMaxRange(nb);


            BOOST_CHECK_EQUAL(stats.getDammages(),nb);
            BOOST_CHECK_EQUAL(stats.getMaxRange(),nb);
            BOOST_CHECK_EQUAL(stats.getMinRange(),nb);
